...
import com.example.helpdeskfelipe.api.APIService;
import com.example.helpdeskfelipe.api.ApiUtils;
import com.example.helpdeskfelipe.modelo.Chamado;
import com.example.helpdeskfelipe.modelo.Status;
...
public class TelaChamado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chamado_tela);
        ...
        response.enqueue(new Callback<ResponseBody>()
        {
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> rawResponse)
            {
                try
                {
                    ...
                    Intent intent = new Intent(TelaChamado.this, TabelaAtividade.class);
